...
# Kyujinpie
# -> remove mmc4 dataset -> environment...sad

# 7/25
# clip, polyglot, batch_size
...
def main():
    ...
    parser.add_argument("--vision_encoder_path", default="ViT-L-14", type=str) # ViT-L-14
    parser.add_argument("--vision_encoder_pretrained", default="openai", type=str)
    parser.add_argument("--lm_path", default="EleutherAI/polyglot-ko-1.3b", type=str) # 1.3B // EleutherAI/polyglot-ko-1.3b
    parser.add_argument(
        "--tokenizer_path",
        default="EleutherAI/polyglot-ko-1.3b", # 1.3B
        type=str,
    ...
    parser.add_argument("--batch_size_mmc4", type=int, default=32)
    parser.add_argument("--batch_size_laion", type=int, default=48) # 64
    ...
    parser.add_argument("--warmup_steps", default=1562, type=int)
    ...
    parser.add_argument(
        "--laion_shards",
        type=str,
        default= './laion_data/shard_{00000..00100}.tar',
    ...
    parser.add_argument("--train_num_samples_laion", type=int, default=150000) # 250000
    parser.add_argument("--dataset_resampled", default = True, action="store_true")
    parser.add_argument(
    ...
    ) # TODO: NCCL로 change해야 GPU 분산 training 됨 / 현재는 single
    parser.add_argument(
        "--horovod",
        default=False,
        action="store_true",
    ...
    if args.fsdp:
        ...
        print("device_id:", device_id) # CUDA
